...
namespace PathCreation
{
    ...
    public class GlobalDisplaySettings : ScriptableObject
    {
        ...
        [Header("Anchor Colours")] public Color anchor = new(0.95f, 0.25f, 0.25f, 0.85f);
        public Color anchorHighlighted = new(1, 0.57f, 0.4f);
        public Color anchorSelected = Color.white;

        [Header("Control Colours")] public Color control = new(0.35f, 0.6f, 1, 0.85f);
        ...
        {
            var guids = UnityEditor.AssetDatabase.FindAssets("t:GlobalDisplaySettings");
            if (guids.Length == 0)
            {
